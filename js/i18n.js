...
const dict = {
  fr: {
    ...
    backToListLink: '← Liste des invités',
    floorPlanTitle: 'Plan de salle',
    addTableBtn: '+ Ajouter une table',
    floorPlanHint: 'Glissez les tables pour composer votre salle. Cliquez sur une table pour gérer ses invités.',
    ...
    tableSeatsLabel: 'Places (optionnel)',
  ...
  en: {
    ...
    backToListLink: '← Guest list',
    floorPlanTitle: 'Floor plan',
    addTableBtn: '+ Add a table',
    floorPlanHint: 'Drag the tables to lay out your venue. Click a table to manage its guests.',
    ...
    tableSeatsLabel: 'Seats (optional)',
  ...
  ro: {
    ...
    backToListLink: '← Lista invitaților',
    floorPlanTitle: 'Plan de sală',
    addTableBtn: '+ Adaugă o masă',
    floorPlanHint: 'Trage mesele pentru a aranja sala. Apasă pe o masă pentru a-i gestiona invitații.',
    ...
    tableSeatsLabel: 'Locuri (opțional)',
